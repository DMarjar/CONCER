...
const AsideGestor = () => {
    ...
    return (
        <>
            ...
            <hr className='mt-1' />
            <NavLink className='pt-1 px-3 py-3' href="/indicators"><VscGraph size={"35"} color="#002e60" />&nbsp; Indicadores</NavLink>
            <NavLink className='pt-1 px-3 py-3' href="/candidates"><IoIosPeople size={"35"} color="#002e60" />&nbsp; Candidatos </NavLink>
